class PickemPick < ActiveRecord::Base
  ...
  def recommendation_points(year, start_week, end_week)
    points = 0
    points += recommend_on_teams(year, start_week, end_week)
    points += recommend_on_team_home(year, start_week, end_week)
    points += recommend_on_team_away(year, start_week, end_week)
    points += recommend_on_team_picked(year, start_week, end_week)
    points += recommend_on_team_not_picked(year, start_week, end_week)
    points += recommend_on_favorites(year, start_week, end_week)
    points += recommend_on_favorites_picked(year, start_week, end_week)
    points += recommend_on_conference(year, start_week, end_week)
    points += recommend_on_division(year, start_week, end_week)
    points += recommend_on_time(year, start_week, end_week)

    return points
  end

  def recommend_on_teams(year, start_week, end_week)
  ...
  def recommend_on_team_home(year, start_week, end_week)
  ...
  def recommend_on_team_away(year, start_week, end_week)
  ...
  def recommend_on_team_picked(year, start_week, end_week)
  ...
  def recommend_on_team_not_picked(year, start_week, end_week)
  ...
  def recommend_on_favorites(year, start_week, end_week)
  ...
  def recommend_on_favorites_picked(year, start_week, end_week)
  ...
  def recommend_on_conference(year, start_week, end_week)
  ...
  def recommend_on_division(year, start_week, end_week)
  ...
  def recommend_on_time(year, start_week, end_week)
