class ApplicationController < ActionController::Base
  ...
  def find_week
    week1 = Time.new(2014, 9, 10)
    week2 = Time.new(2014, 9, 17)
    week3 = Time.new(2014, 9, 24)
    week4 = Time.new(2014, 9, 31)
    week5 = Time.new(2014, 10, 8)
    week6 = Time.new(2014, 10, 15)
    week7 = Time.new(2014, 10, 22)
    week8 = Time.new(2014, 10, 29)
    week9 = Time.new(2014, 11, 5)
    week10 = Time.new(2014, 11, 12)
    week11 = Time.new(2014, 11, 19)
    week12 = Time.new(2014, 11, 26)
    week13 = Time.new(2014, 12, 3)
    week14 = Time.new(2014, 12, 10)
    week15 = Time.new(2014, 12, 17)
    week16 = Time.new(2014, 12, 24)
    week17 = Time.new(2014, 12, 31)
